...
module.exports = {
  ...
  */
  ...
  output: {
    ...
    */
    filename: 'dist/example_2/[name].js', // will resolve to 'dist/example_2/mdocter.form.js' etc.
  ...
  module: {
    ...
    loaders: [
      // all files with a `.ts` or `.tsx` extension will be handled by loader 'ts-loader' (https://github.com/TypeStrong/ts-loader)
      {
        test: /\.tsx?$/,
        loader: 'ts-loader'
      }
